...
const form = useForm({
    ...
    responsibilities: parseArray(props.experience.responsibilities),
    technologies: parseArray(props.experience.technologies),
                ...
                <div class="flex items-center justify-between h-16">
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <h1 class="text-xl font-bold text-white">Edit Experience</h1>
                                <p class="text-sm text-slate-300">Update {{ experience.title }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div v-show="currentStep === 1" class="p-8">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-slate-300">Update your role and workplace information</p>
                        </div>
                    ...
                    <div v-show="currentStep === 2" class="p-8">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-slate-300">Update the employment dates</p>
                        </div>
                    ...
                    <div v-show="currentStep === 3" class="p-8">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-slate-300">Update your role description and accomplishments</p>
                        </div>
                    ...
                    <div v-show="currentStep === 4" class="p-8">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-slate-300">Update specific responsibilities and technologies used</p>
                        </div>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex space-x-3">
                                ...
                                >
                                    ...
                                    <span>{{ form.processing ? 'Updating...' : 'Update Experience' }}</span>
                                </button>
                            </div>
                        </div>
                    </div>
