...
const parseTechnologies = (technologies: any): string[] => {
    ...
    if (typeof technologies === 'string') {
        try {
            ...
            return Array.isArray(parsed) ? parsed : [technologies];
        } catch {
...
const form = useForm({
    ...
    technologies: parseTechnologies(props.project.technologies),
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-300">Update {{ project.title }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit">
                    ...
                    <div v-show="currentStep === 1" class="p-8">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-slate-300">Update the project name and description</p>
                        </div>
